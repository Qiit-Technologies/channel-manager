...
@Injectable()
export class OreonSyncService {
  private readonly logger = new Logger(OreonSyncService.name);

  constructor(
    private readonly channelManagerRepository: ChannelManagerRepository
  ) {}

  // Sync room types from Oreon to channel manager
