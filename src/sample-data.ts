...
export const sampleChannelIntegrations = {
  ...
  list: [
    ...
    },
    {
      id: 5,
      hotelId: 8,
      channelType: ChannelType.CORNICHE,
      channelName: "Corniche Hotel Integration",
      status: IntegrationStatus.ACTIVE,
      apiKey: "CornicheLive_2026#W9xT4qL8zR2m",
      apiSecret: "CornicheLive_2026#W9xT4qL8zR2m",
      accessToken: null,
      refreshToken: null,
      channelPropertyId: "CORNICHE-PROP-008",
      channelUsername: null,
      channelPassword: null,
      webhookUrl:
        "https://www.thecornichehotel.com/wp-json/cmw/v1/webhooks/CORNICHE",
      webhookSecret: "CornicheLive_2026#W9xT4qL8zR2m",
      isWebhookEnabled: true,
      syncIntervalMinutes: 30,
      isRealTimeSync: true,
      lastSyncAt: new Date("2025-01-15T12:00:00.000Z"),
      lastSuccessfulSync: new Date("2025-01-15T12:00:00.000Z"),
      errorMessage: null,
      testMode: false,
      channelSettings: {
        autoSync: true,
      ...
      createdAt: new Date("2025-02-16T10:00:00.000Z"),
